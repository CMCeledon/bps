				...
				.EnableSwagger(c =>
					{
						...
						//
						c.IncludeXmlComments(string.Format(@"{0}\bin\BPS.MVC.xml",
				...
				.EnableSwaggerUi(c =>
					{
						...
						//c.InjectJavaScript(thisAssembly, "SwashbuckleCustomAuth.CustomContent.api-key-header-auth.js");
